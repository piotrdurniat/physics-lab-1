...
Gdy jeden z czterech rezystorów jest nieznany, to można wyznaczyć jego rezystancję z powyższej proporcji \eqref{eq:wheatstone_proporcja}, znając wartości pozostałych trzech elementów.
