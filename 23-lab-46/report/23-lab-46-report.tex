...
\subsection{Obliczenie prądów I1, I2, I3=I4}

Na podstawie praw Kirchhoffa oraz prawa Ohma, obliczono wartości prądów w układzie z schematu 1. Wzory na prądy wynoszą:
\begin{equation}
	\begin{cases}
		I_1 = \frac{\mathcal{E} (R_2 + R_3 + R_4)}{R_1 (R_2 + R_3 + R_4) + R_2 (R_3 + R_4)} \\
		I_2 = \frac{\mathcal{E} R_2}{R_1 (R_2 + R_3 + R_4) + R_2 (R_3 + R_4)}               \\
		I_3 = I_4 = \frac{\mathcal{E} (R_3 + R_4)}{R_1 (R_2 + R_3 + R_4) + R_2 (R_3 + R_4)}
	\end{cases}
\end{equation}
